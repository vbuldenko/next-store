...
const HeaderCategorySelector = async () => {
  ...
  const categories = [
    { _id: "1", slug: { current: "electronics" }, title: "Electronics" },
    { _id: "2", slug: { current: "fashion" }, title: "Fashion" },
    {
      _id: "3",
      slug: { current: "home-appliances" },
      title: "Home Appliances",
    },
    { _id: "4", slug: { current: "books" }, title: "Books" },
    { _id: "5", slug: { current: "toys" }, title: "Toys" },
  ];
