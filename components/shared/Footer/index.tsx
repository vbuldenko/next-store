...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-gray-100 py-6 backdrop-blur-sm">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              Bringing quality products to your doorstep with a seamless
              shopping experience.
            </p>
          </div>
              ...
              {socialLinks.map((social) => (
                ...
                >
                  ...
                  >
                    <path
                      d={social.icon}
                      fillRule={social.rule ? "evenodd" : undefined}
                      clipRule={social.rule ? "evenodd" : undefined}
                    />
                  </svg>
                </a>
              ))}
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-800 text-center text-xs text-gray-500 dark:text-gray-400">
          ...
          <p className="mt-1 text-gray-400 dark:text-gray-500 text-[10px]">
